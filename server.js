...
// Creates a handler to route the // request based on the path name 

function start(handle, port)
{
	function onRequest(req, res)
	{
		var urldata = url.parse(req.url, true), pathname = urldata.pathname,
		var info = 
		{
			"res" : res,
			"query" : urldata.query,
...
// Opens, reads, and sends to the client the contents of the // named file
function serveFile(filepath, info)
{
	var res = info.res, query = info.query;
